...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('eliminar video?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">no se encontraron listas de reproducción!</p>';
      }
   }else{
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Actualizar</a>
            <input type="submit" value="delete_playlist" class="delete-btn" onclick="return confirm('eliminar playlist?');" name="delete">
         </form>
