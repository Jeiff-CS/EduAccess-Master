...
<section class="contents">
   ...
   <h1 class="heading">Tu contenido</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Crear nuevo contenido</h3>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Eliminar este video?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">Aún no se han añadido contenidos!</p>';
      }
   ?>
