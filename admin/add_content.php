...
<section class="video-form">
   ...
   <h1 class="heading">Actualizar Contenido</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Estado del video <span>*</span></p>
      <select name="status" class="box" required>
         <option value="" selected disabled>-- Seleccionar estado</option>
         <option value="active">activo</option>
         <option value="deactive">inactivo</option>
      </select>
      <p>Titulo del video <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Titulo del video" class="box">
      <p>Descripcion del Video <span>*</span></p>
      ...
      <p>Selecciona miniatura <span>*</span></p>
