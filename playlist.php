...
<section class="playlist">
   ...
   <h1 class="heading">Contenido de Playlist</h1>
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>Guardado</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>guardar playlist</span></button>
            <?php
               }
            ?>
         </form>
