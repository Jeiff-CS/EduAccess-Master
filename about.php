...
<section class="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div>
            <h3>+25k</h3>
            <span>Estudiantes brillantes</span>
         </div>
      </div>
...
<section class="reviews">
   ...
   <h1 class="heading">Resenas de Estudiantes</h1>

   <div class="box-container">

      <div class="box">
         <p>El amigo es weno!!, para que ah!</p>
         <div class="user">
      ...
      <div class="box">
         <p>El profe jhoan deja mucha tarea dicen los alumnos de 9no ciclo</p>
         <div class="user">
      ...
      <div class="box">
         <p>Busquenme en tinder para un final feliz!</p>
         <div class="user">
