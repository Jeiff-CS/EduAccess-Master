...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">EduAccess.</a>

      <form action="search_course.php" method="post" class="search-form">
         <input type="text" name="search_course" placeholder="burcar curso..." required maxlength="100">
      ...
      <div class="profile">
         ...
         <a href="components/user_logout.php" onclick="return confirm('logout from this website?');" class="delete-btn">Cerrar Sesion</a>
         <?php
            }else{
         ?>
...
<div class="side-bar">
   ...
   <div class="profile">
         ...
         ?>
         <h3>Iniciar Sesion o Registrese</h3>
   ...
   <nav class="navbar">
      ...
      <a href="about.php"><i class="fas fa-question"></i><span>Nosotros</span></a>
