...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">EduAccess Admin.</a>
      ...
      <div class="profile">
         ...
         <a href="../components/admin_logout.php" onclick="return confirm('logout from this website?');" class="delete-btn">Cerrar Sesion</a>
         <?php
            }else{
         ?>
         <h3>Porfavor loguese o registrese</h3>
          <div class="flex-btn">
            <a href="login.php" class="option-btn">Login</a>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="admin-manual.php"><i class="fa-solid fa-address-book"></i><span>Manual Docente</span></a>
      <a href="../components/admin_logout.php" onclick="return confirm('logout from this website?');"><i class="fas fa-right-from-bracket"></i><span>Cerrar Sesion</span></a>
   </nav>
